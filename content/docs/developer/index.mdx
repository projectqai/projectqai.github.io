...
<Cards>
  ...
  <Card title="Plugins" href="/docs/developer/plugins">
  ...
  <Card title="Entity Merge & Synchronization" href="/docs/developer/merge">
    How entities are merged across distributed peers with LWW and shadow convergence
  </Card>
