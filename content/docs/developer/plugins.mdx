...
We can filter for specific entities, enriching them with your own data, and push changes back. This is exactly what the [HexDB plugin](https://github.com/projectqai/hydra/blob/main/core/plugins/hexdb/index.ts) does to add aircraft photos.
