...
description: Connect downstream mission systems to Hydris's situational awareness picture
---
...
This guide explains how to integrate a downstream mission system with Hydris. By the end, you'll understand:

- The integration architecture
- How to receive entities from Hydris (COP, tracks, sensor status)
- How to push entities to Hydris (own position, detections)
...
Hydris exposes an API on **port 50051** using [ConnectRPC](https://connectrpc.com/). ConnectRPC supports multiple protocols:

- **gRPC** - Full gRPC with HTTP/2 streaming
- **gRPC-Web** - Browser-compatible gRPC
- **Connect (REST)** - JSON over HTTP/1.1 or HTTP/2

This means you can use REST-style JSON requests if your system doesn't support gRPC natively.

### Bidirectional Data Flow

```
┌─────────────────────┐                      ┌─────────────────────┐
│   Mission System    │                      │        Hydris        │
│                     │                      │                     │
│  ┌───────────────┐  │      Push()          │  ┌───────────────┐  │
│  │ Own Position  │──┼─────────────────────>│  │               │  │
│  │ Sensor Data   │  │                      │  │   Entity      │  │
...
**Inbound to Hydris (your system pushes):**
- Own platform position
- Sensor detections
- Asset status

**Outbound from Hydris (your system receives):**
...
|--------|------|-------------|
| `Push` | Unary | Push entities to Hydris |
...
## Receiving Entities from Hydris
...
For the complete entity structure and all available components, see the [Component Reference](/docs/developer/components).
...
2. **Establish connection** to Hydris on port 50051
...
Proto files are available at: [github.com/projectqai/hydris/proto](https://github.com/projectqai/hydris)

## Next Steps

- [Component Reference](/docs/developer/components) - Detailed documentation of all components
- [Creating Entities](/docs/developer/creating-entities) - More examples of entity creation
- [Taskables](/docs/developer/taskables) - Coordinate actions between systems
